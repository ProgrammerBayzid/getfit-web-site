...
const AllOnlineDoctorMobile = ({ closeModalMobile }) => {
  ...
  const getDoctor = async () => {
    try {
      ...
      if (online !== false) url += `&online=${online}`;
        ...
        <div>
          <div>
            <div className="flex justify-between mb-[8px]">
              <h1 className="sm:text-[14px] custom:text-[16px] md:text-[13px] text-[12px]  font-inter font-bold text-[#101011] mb-[9px]">
                যে সকল নিউট্রিশনিস্ট অনলাইনে আছেন
              </h1>
              <button
                type="button"
...
export default AllOnlineDoctorMobile;
