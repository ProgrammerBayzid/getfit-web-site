...
isToggledLanguage === true ?
      <div
        className={`${
          currentPath === "/privacy-policy?navigation=true"
      ...
      >
        <div>
          <div>
            {currentPath === "/terms-and-conditions?navigation=true" ? (
              <></>
            ) : (
            ...
            <div className="my-[10px]">
              <div>
                <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                  অনুগ্রহ করে এই শর্তাবলী গুলো সাবধানে পড়ুন। এই
                  অ্যাপ্লিকেশানটির অ্যাক্সেস এবং ব্যবহার চালিয়ে যাওয়ার মাধ্যমে
                  আপনি নিশ্চিত করছেন যে আপনি এখানে বর্ণিত আমাদের শর্তাবলী
                  স্বীকার করছেন৷
                </p>
                <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                ...
                <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px] mt-[14px]">
                  গেটফিট স্বাস্থ্য সেবায় স্বাগতম। এই সার্ভিস এবং অ্যাপটি Bringin
                  Technologies Limited দ্বারা পরিচালিত হয়, যার নিবন্ধিত অফিস
                  রয়েছে (ঠিকানা:ফ্ল্যাট 2B, বাড়ি 254, রোড 09, ব্লক সি, বসুন্ধরা
                  R/A, ঢাকা)।
                </p>
              </div>
            </div>
            <div className="mt-[13px]">
              <h2 className="text-[#101011] font-bold font-noto text-[16px]">
                আমাদের সার্ভিস
              </h2>
              ...
              <div className="ml-[10px]">
                <div className="flex gap-x-[10px] ">
                  ...
                  <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                    গেটফিট যোগ্য এবং অভিজ্ঞ নিউট্রিশনিস্টদের মাধ্যমে বাংলাদেশের
                    মানুষদের জন্য পুষ্টি ও স্বাস্থ্যসেবা প্রদান করে। তবে এটা মনে
                    রাখবেন আমাদের অ্যাপ কোন জরুরি বা শারীরিক রোগের চিকিৎসা সেবা
                    প্রদান করে না। নিবন্ধিত নিউট্রিশনিস্টরা শুধুমাত্র ডায়েট
                    প্ল্যান এবং খাদ্যাভ্যাস পরিবর্তনের মাধ্যমে জীবন দ্বারা উন্নত
                    করার ব্যাপারে পরামর্শ প্রদান করে।
                  </p>
                </div>
                <div className="flex gap-x-[10px] ">
                  <div className="w-[5px] h-[5px] mt-[6.5px]">
              ...
              <div className="ml-[10px]">
                ...
                <div className="flex gap-x-[10px] ">
                  ...
                  <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                    ...
                    নিউট্রিশনিস্ট সম্পূর্ণভাবে দায়ী এবং দায়বদ্ধ। গেটফিট এর কোন
                    দায়ভার বহন করে না।
                  </p>
                </div>
                <div className="flex gap-x-[10px] ">
                  ...
                  <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                    ...
                    নিউট্রিশনিস্টদের থেকে কনসাল্টেশন নেয় বা ক্ষতিগ্রস্ত হয় তার
                    জন্য গেটফিট দায়ী থাকবে না। নিউট্রিশনিস্টদের সাথে সকল প্রকার
                    যোগাযোগের জন্য গেটফিটকেই মাধ্যম হিসেবে ব্যবহার করার জন্য
                    উৎসাহিত করা হয়।
                  </p>
                </div>
              </div>
            ...
            <div className="mt-[13px]">
              ...
              <div className="ml-[10px]">
                <div className="flex gap-x-[10px] ">
                  ...
                  <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                    আমাদের প্ল্যাটফর্মটি ব্যবহার করতে আপনার বয়স কমপক্ষে ১৮ বছর
                    বা তার বেশি হতে হবে, একটি সুস্থ মন থাকতে হবে এবং প্রাথমিক
                    ব্যবহারকারী হিসাবে সেবাগুলি ব্যবহার করার জন্য কোনও আইন
                    দ্বারা চুক্তিতে বাধা দেওয়া হবে না। যদি ব্যবহারকারী একটি
                    অপ্রাপ্তবয়স্ক (অর্থাৎ ১৮ বছরের কম বয়সী ব্যক্তি) হয়, তবে
                    কেবলমাত্র সেই ব্যক্তির আইনি অভিভাবক/প্রতিনিধি নিজেকে
                    প্রাথমিক ব্যবহারকারী হিসাবে নিবন্ধন করতে হবে এবং সেকেন্ডারি
                    ইউজার হিসেবে নাবালকের প্রোফাইল তৈরি/সংযোজন করতে হবে।
                  </p>
                </div>
                <div className="flex gap-x-[10px] ">
                  <div className="w-[5px] h-[5px] mt-[6.5px]">
                  ...
                  <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                    ...
                    হবে। একজন সেকেন্ডারি ব্যবহারকারী শুধুমাত্র একজন সেবাগ্রহীতা
                    হিসেবে প্রাথমিক ব্যবহারকারীর মাধ্যমে সেবা পেতে পারেন।
                    প্রাথমিক ব্যবহারকারী অ্যাপ্লিকেশনটিতে সেকেন্ডারি
                ...
                <div className="flex gap-x-[10px] ">
                  ...
                  <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                    আপনি আপনার ইউজার একাউন্ট ইনফরমেশন কারো সাথে শেয়ার করবেন না।
                    আপনার অ্যাকাউন্টের তথ্য এবং পাসওয়ার্ডের গোপনীয়তা বজায়
                    রাখার জন্য আপনি দায়ী৷ আপনি আপনার অ্যাকাউন্ট এবং
            ...
            <div className="mt-[13px]">
              ...
              <div className="ml-[10px]">
                <div className="flex gap-x-[10px] mb-[15px]">
                  <div className="w-[5px] h-[5px] mt-[6.5px]">
                    <div className="w-[5px] h-[5px] bg-black rounded-full"></div>
                  </div>
                  <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                    যদি আপনার বয়স ৩৫ (পঁয়ত্রিশ) বছরের বেশি হয়, অথবা আপনি যদি
                    ১ (এক) বছরের বেশি সময় ধরে শারীরিকভাবে সক্রিয় না থাকেন, বা
                    আপনার যদি এমন কোনো চিকিৎসা ইতিহাস থাকে যা আপনাকে ডায়েটের
                    কারণে স্বাস্থ্য ঝুঁকিতে ফেলতে পারে, সেক্ষেত্রে এক বা একাধিক
                    শর্তে, আপনি সম্মত হন যে আপনি সেবাগুলি ব্যবহার করার আগে একজন
                    যোগ্য ডাক্তারের কাছ থেকে অনুমোদন নিয়েছেন এবং ডায়েট গ্রহণের
                    সময় কোনও স্বাস্থ্যের পরিণতি বা ওষুধের মিথস্ক্রিয়ার জন্য
                    গেটফিট দায়ী থাকবে নাঃ <br /> ১। অয়েট লস <br /> ২। অয়েট গেইন{" "}
                    <br /> ৩। থাইরয়েড <br /> ৪। PCOS/PCOD <br />
                    ৫। ডায়াবেটিস <br />
                    ৬। বেবী নিউট্রিশন
                ...
                <div className="flex gap-x-[10px] ">
                  ...
                  <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                    ...
                    কনসাল্টেশন নেওয়া সম্ভব না হলে অন্য কোন সময়ে সেবা গ্রহণ করতে
                    পারবেন।
                  </p>
                </div>
                <div className="flex gap-x-[10px] ">
                  ...
                  <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                    ...
                    চলাকালীন সময়ে যে কোনো চিকিৎসা অবস্থার জন্য গেটফিট দায়ী হবে
                    না। আপনি নিশ্চিত করেন যে ডায়েট চালানোর সময় যে কোনও মেডিকেল
                    সমস্যাগুলি ডায়েটের সাথে সম্পর্কিত হবে না।
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="ml-[10px]">
                <div className="flex gap-x-[10px] ">
                  ...
                  <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                    ...
                    সাপোর্ট টিমে (refund@getfit.com.bd) যোগাযোগ করার জন্য অনুরোধ
                    করা হলো।
                  </p>
                </div>
                <div className="flex gap-x-[10px] ">
                ...
                <div className="flex gap-x-[10px] ">
                  ...
                  <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                    ...
                    মিনিটের মধ্য কনসাল্টেশন বাতিলের জন্য আবেদন করলে সেটি বিবেচিত
                    হবে। অন্যথায় সেটি বাতিল ও অর্থ ফেরতের অযোগ্য বলে বিবেচিত
                    হবে।
                  </p>
                </div>
                <div className="flex gap-x-[10px] ">
            ...
            <div className="mt-[13px]">
              ...
              <div className="ml-[10px]">
                ...
                <div className="flex gap-x-[10px] ">
                  ...
                  <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                    কোন ব্যবহারকারী যদি তার একাউন্টটি স্থায়ী ভাবে বন্ধ করতে চায়
                    তাহলে তাকে সরাসরি আমাদের আমাদের একাউন্ট সাপোর্ট টিমে যোগাযোগ
                    করতে হবে।
                  </p>
                </div>
                <div className="flex gap-x-[10px] ">
                  ...
                  <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                    ...
                    (account@getfit.com.bd) অথবা কল করুন +8801635401965 নম্বরে।
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-[13px]">
              ...
              <div className="ml-[10px]">
                <div className="flex gap-x-[10px] ">
                  ...
                  <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                    গেটফিট তার ব্যবহারের শর্তাবলী যে কোন সময় পরিবর্তন করতে পারে।
                  </p>
                </div>
                <div className="flex gap-x-[10px] ">
                  <div className="w-[5px] h-[5px] mt-[6.5px]">
            ...
            <div className="mt-[13px]">
              ...
              <div className="ml-[10px]">
                <div className="flex gap-x-[10px] ">
                  ...
                  <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                    এই ব্যবহারের শর্তাবলী শুধুমাত্র বাংলাদেশের আইন অনুযায়ী গঠিত
                    ও বাস্তবায়িত। শর্তাবলীর ব্যাখ্যা এবং যে কোন বিরোধ নিষ্পত্তির
                    ক্ষেত্রে বাংলাদেশী আইন প্রযোজ্য হবে। যে কোন ধরনের সেবা বা
                    আমাদের সাথে কোন চুক্তি সম্পর্কিত বিরোধ নিষ্পত্তির ক্ষেত্রে
                    বাংলাদেশের আদালতের একচেটিয়া এখতিয়ার থাকবে।
                  </p>
                </div>
              </div>
            </div>
       ...
       <div>
         <div>
             ...
             <div className="ml-[10px]">
                  ...
                  <div>
                    <div className="flex gap-x-[10px] ">
                      ...
                      <p className="text-[#101011] text-opacity-90 font-semibold font-inter text-[14px]">
                      Getfit only provides services in the following areas:
                      </p>
                    </div>
                    <p className="text-[#101011] text-opacity-90 font-normal font-inter text-[14px] ml-[17px]">
                      1. Weight Loss
                      <br />
                      2. Weight Gain <br />
                      3. Thyroid
           ...
           <div className="mt-[13px]">
             ...
             <div className="ml-[10px]">
               <div className="flex gap-x-[10px] ">
                 ...
                 <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                 If a user has made payment for a package purchase on Getfit, they will not be eligible for refund. However, under special consideration, they may be eligible for refund. For this, they are requested to contact our support team directly at refund@getfit.com.bd.
                 </p>
               </div>
               <div className="flex gap-x-[10px] ">
                 <div className="w-[5px] h-[5px] mt-[6.5px]">
                 ...
                 <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                 If 30 days have passed after purchasing the package, the user will not be able to apply for or receive a refund.
                 </p>
               </div>
               <div className="flex gap-x-[10px] ">
                 <div className="w-[5px] h-[5px] mt-[6.5px]">
                 ...
                 <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                 If an application is submitted to cancel an instant consultation within 30 minutes of payment, it will be considered. Otherwise, it will be considered ineligible for cancellation and refund.
                 </p>
               </div>
               <div className="flex gap-x-[10px] ">
                 <div className="w-[5px] h-[5px] mt-[6.5px]">
                 ...
                 <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                 We may deduct taxes/VAT or other fees, it may depend on the type of refund requested.
                 </p>
               </div>
               <div className="flex gap-x-[10px] ">
                 <div className="w-[5px] h-[5px] mt-[6.5px]">
           ...
           <div className="mt-[13px]">
             ...
             <div className="ml-[10px]">
               <div className="flex gap-x-[10px] ">
                 ...
                 <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                 Getfit can close or deactivate your account and a user also has the ability to close their account at any time.
                 </p>
               </div>
               <div className="flex gap-x-[10px] ">
                 <div className="w-[5px] h-[5px] mt-[6.5px]">
                 ...
                 <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                 If any user wishes to permanently close their account, they must directly contact our account support team.
                 </p>
               </div>
               <div className="flex gap-x-[10px] ">
                 <div className="w-[5px] h-[5px] mt-[6.5px]">
                 ...
                 <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                 To contact the account support team, please email us at account@getfit.com.bd or call us at +8801635401965.
                 </p>
               </div>
             </div>
           </div>
           <div className="mt-[13px]">
             ...
             <div className="ml-[10px]">
               <div className="flex gap-x-[10px] ">
                 ...
                 <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                 The site contains various features and elements such as graphics, content, images, and materials and Getfit owns these items. The services are protected by copyright, trademarks and other laws of Bangladesh. Without our prior permission, none of our property or services can be used elsewhere.
                 </p>
               </div>
             </div>
           </div>
           <div className="mt-[13px]">
             ...
             <div className="ml-[10px]">
               <div className="flex gap-x-[10px] ">
                 ...
                 <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                 Getfit reserves the right to change its terms of use at any time.
                 </p>
               </div>
               <div className="flex gap-x-[10px] ">
                 <div className="w-[5px] h-[5px] mt-[6.5px]">
                 ...
                 <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                 Stay connected with our website or app to be informed about any changes or additions to the terms and conditions of use.
                 </p>
               </div>
             </div>
           </div>
           <div className="mt-[13px]">
             ...
             <div className="ml-[10px]">
               <div className="flex gap-x-[10px] ">
                 ...
                 <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                 This terms of use is solely formulated and enforced according to the laws of Bangladesh. In the event of any explanation of the terms or resolution of any disputes, Bangladeshi law shall apply. Exclusive jurisdiction of the courts of Bangladesh shall prevail in any disputes related to any services or agreements with us.
                 </p>
               </div>
             </div>
           </div>
           <div className="mt-[15px]">
             <div>
               <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
               If you have any questions about our terms and conditions, please contact us at hello@getfit.com.bd. Thank you very much for being with Getfit.
               </p>
             </div>
           </div>
         </div>
