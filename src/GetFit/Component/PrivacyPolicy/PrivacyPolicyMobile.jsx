            ...
            <div>
              ...
              >
                ...
                <div className="mt-[13px]">
                  ...
                  <p className="text-[#101011] text-opacity-90 font-normal font-inter text-[14px]">
                    To get health and nutrition services, you may provide us
                    some information that identifies you or other users
                    associated with your account.
                  </p>
                  <p className="text-[#101011] text-opacity-90 font-normal font-inter text-[14px] mt-[13px]">
                    We may collect the following information from you or other
                    users associated with you, but this list is not exhaustive
                    and other information may also be needed.
                  </p>
                </div>
                <div className="mt-[13px]">
                  <h2 className="text-[#101011] font-bold font-inter text-[16px]">
                  ...
                  <div className="ml-[10px]">
                    ...
                    <div className="flex gap-x-[10px] ">
                      ...
                      <p className="text-[#101011] text-opacity-90 font-normal font-inter text-[14px]">
                        ...
                        language, referring URL, file access, time, operating
                        system, and information about your visits collected in
                        our log files, including the pages you visit on our
                        website or application and the time spent on those
                        pages, and other statistics ("log data").,
                      </p>
                    </div>
                    <div className="flex gap-x-[10px] mt-[10px]">
                      ...
                      <p className="text-[#101011] text-opacity-90 font-normal font-inter text-[14px]">
                        Any other information provided by you will be referred
                        to collectively as "personal information.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="ml-[10px]">
                    ...
                    <div className="flex gap-x-[10px] ">
                      ...
                      <p className="text-[#101011] text-opacity-90 font-normal font-inter text-[14px]">
                        ...
                        number, email, etc. (only internal employees will be
                ...
                <div className="mt-[13px]">
                  ...
                  <div className="ml-[10px]">
                    ...
                    <div className="flex gap-x-[10px] ">
                      ...
                      <p className="text-[#101011] text-opacity-90 font-normal font-inter text-[14px]">
                        Content that you have permitted us to access through
                        your device (discussed below).,
                      </p>
                    </div>
                    <div className="flex gap-x-[10px] ">
                      <div className="w-[5px] h-[5px] mt-[6.5px]">
                ...
                <div className="mt-[13px]">
                  ...
                  <div className="ml-[10px]">
                    ...
                    <div className="flex gap-x-[10px] ">
                      ...
                      <p className="text-[#101011] text-opacity-90 font-normal font-inter text-[14px]">
                        To communicate with you via phone, SMS, email, or
                        WhatsApp for announcements regarding various issues such
                        as appointments, technical problems, payments, feedback,
                    ...
                    <div className="flex gap-x-[10px] ">
                      ...
                      <p className="text-[#101011] text-opacity-90 font-normal font-inter text-[14px]">
                        ...
                        SMS, email, or third-party communication channels such
                        as WhatsApp, Facebook, etc.;
                      </p>
                    </div>
                    <div className="flex gap-x-[10px] ">
                      <div className="w-[5px] h-[5px] mt-[6.5px]">
                ...
                <div className="mt-[13px]">
                  ...
                  <div>
                    <div>
                      <p className="my-[12px] text-[#101011] text-opacity-90 font-normal font-inter text-[14px]">
                        <span className="text-[#101011] font-semibold font-inter text-[14px]">
                          Camera:
                        </span>{" "}
                ...
                <div className="mt-[13px]">
                  ...
                  <div>
                    <p className="text-[#101011] text-opacity-90 font-normal font-inter text-[14px]">
                      We may store some data (which is not sensitive personal
                      data or information) on your computer or device as
                      temporary or permanent cookies. You can delete or block
                      these cookies from your device. We do not control the use
                  ...
                  <div className="ml-[10px]">
                    <div className="flex gap-x-[10px] ">
                      ...
                      <p className="text-[#101011] text-opacity-90 font-normal font-inter text-[14px]">
                        ...
                        our own discretion. Stay connected with our website or
                        app for any changes or additions to the privacy policy.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="my-[10px]">
                <div>
                  <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                    ...
                    অ্যাপ্লিকেশন অথবা সার্ভিস ব্যবহার করেন তখন আপনার তথ্য
                    সংগ্রহ, ব্যবহার, সঞ্চয়, প্রক্রিয়াকরণ, প্রকাশের ক্ষেত্রে
                    প্রযোজ্য।
                  </p>
                </div>
                <div className="mt-[13px]">
                  ...
                  <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                    ...
                    আমাদের কিছু তথ্য প্রদান করতে হতে পারে, যা ব্যক্তিগতভাবে
                    আপনাকে বা আপনার সাথে সম্পর্কিত অন্যান্য ব্যবহারকারীদের পরিচয়
                    সনাক্ত করে।
                  </p>
                  <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px] mt-[13px]">
                    আপনার বা আপনার সাথে সম্পর্কিত অন্যান্য ব্যবহারকারীদের
                    সম্পর্কে আমরা আপনার কাছ থেকে যে তথ্য সংগ্রহ করতে পারি, তা
                    নিম্নে উল্লেখ করা হলো, তবে এগুলো ছাড়াও অন্যান্য তথ্য থাকতে
                    পারে:
                  </p>
                </div>
                <div className="mt-[13px]">
                  ...
                  <div className="ml-[10px]">
                    ...
                    <div className="flex gap-x-[10px] ">
                      ...
                      <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                        সেবা গ্রহন অথবা অনলাইনে পেমেন্ট করার সময় বৈধ আর্থিক
                        তথ্য,
                      </p>
                    </div>
                    <div className="flex gap-x-[10px] ">
                      ...
                      <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                        রেজিস্ট্রেশনের সময় বা তার পরে দেওয়া ব্যবহারকারীর
                        বিবরণ,
                      </p>
                    </div>
                    <div className="flex gap-x-[10px] ">
                      ...
                      <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                        ...
                        বিবরণ, আমাদের ওয়েবসাইট বা অ্যাপ্লিকেশনের পেইজগুলি যা
                        আপনি ভিজিট করেন এবং সেই পেইজগুলিতে ব্যয় করা সময় এবং
                        অন্যান্য পরিসংখ্যান ("লগ ডেটা"),
                      </p>
                    </div>
                    <div className="flex gap-x-[10px] mt-[10px]">
                      <div className="w-[5px] h-[5px] mt-[6.5px]">
                ...
                <div className="mt-[13px]">
                  ...
                  <div className="ml-[10px]">
                    ...
                    <div className="flex gap-x-[10px] ">
                      ...
                      <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                        জাতীয় পরিচয়পত্র, পাসপোর্ট, ব্যাংক ইনফরমেশন মোবাইল
                        নাম্বার, ইমেইল ইত্যাদি (এই তথ্যগুলি শুধুমাত্র আমাদের
                        অভ্যন্তরীণ কর্মকর্তারা দেখতে পাবে)
                      </p>
                    </div>
                    <div className="flex gap-x-[10px] ">
                      <div className="w-[5px] h-[5px] mt-[6.5px]">
                ...
                <div className="mt-[13px]">
                  ...
                  <div className="ml-[10px]">
                    <div className="flex gap-x-[10px] ">
                      ...
                      <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                        আপনি যখন আমাদের ওয়েবসাইট বা অ্যাপ্লিকেশনে নিবন্ধন
                        করবেন,
                      </p>
                    </div>
                    <div className="flex gap-x-[10px] ">
                  ...
                  <div className="ml-[10px]">
                    ...
                    <div className="flex gap-x-[10px] ">
                      ...
                      <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                        ...
                        শর্তাবলী লঙ্ঘন, আপনার সাথে আমাদের চুক্তি লঙ্ঘনের
                        ব্যাপারে আইন দ্বারা প্রয়োজনীয় বিষয়ে পদক্ষেপ নিতে;
                      </p>
                    </div>
                    <div className="flex gap-x-[10px] ">
                      <div className="w-[5px] h-[5px] mt-[6.5px]">
                ...
                <div className="mt-[13px]">
                  ...
                  <div>
                    <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                      একবার অ্যাপটি ডাউনলোড এবং ইনস্টল হয়ে গেলে, অ্যাপটিকে
                      আপনার ডিভাইসে ক্রিয়া সম্পাদন করার জন্য কিছু নির্দিষ্ট
                      অনুমতি দেওয়ার জন্য অনুরোধ করা হতে পারে। এই অনুমতি গুলো
                      হলো:
                    </p>
                  </div>
                  <div>
                    <div>
                      <p className="my-[12px] text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                        <span className="text-[#101011] font-semibold font-noto text-[14px]">
                          ক্যামেরা:
                        </span>{" "}
                        ডাক্তার/নিউট্রিশনিস্টের সাথে ভার্চুয়াল পরামর্শের জন্য
                        এবং আপনার নথির ছবি তোলার জন্য অনুমতি প্রয়োজন;
                      </p>
                    </div>
                    <div>
                      <p className="my-[12px] text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                    ...
                    <div>
                      <p className="my-[12px] text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                        ...
                        ডাক্তার এবং নিউট্রিশনিস্টের সাথে কথা বলা/কনসাল্টেশন
                        নেয়ার জন্য অনুমতি প্রয়োজন;
                      </p>
                    </div>
                  </div>
                </div>
                <div className="mt-[13px]">
                  ...
                  <div>
                    <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                      ...
                      সংরক্ষণ করতে আপনার কম্পিউটার বা ডিভাইসে অস্থায়ী বা
                      স্থায়ী কুকিজ হিসেবে সংরক্ষণ করতে পারি। আপনি আপনার ডিভাইস
                      থেকে এই কুকিজ গুলি মুছে ফেলতে বা ব্লক করতে পারেন। আমরা কোন
                      তৃতীয় পক্ষের দ্বারা কুকিজ ব্যবহার নিয়ন্ত্রণ করি না।
                    </p>
                  </div>
                </div>
                <div className="mt-[13px]">
                  ...
                  <div>
                    <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                      ...
                      সংগৃহীত ব্যক্তিগত তথ্য (সুরক্ষিত স্বাস্থ্য তথ্য) নিরাপদ
                      কিনা তা নিশ্চিত করার জন্য আমরা যুক্তিসঙ্গত নিরাপত্তা
                      পদ্ধতি গ্রহণ করেছি। আমরা আমাদের এবং আমাদের সহযোগীদের
                      কর্মচারী, এজেন্ট বা তৃতীয় পক্ষের সেবা প্রদানকারী এবং
                      এজেন্সিদের কাছে আপনার ব্যক্তিগত তথ্যের অনুমতি প্রদান করি
                      না।
                    </p>
                  </div>
                </div>
                  ...
                  <div className="ml-[10px]">
                    <div className="flex gap-x-[10px] ">
                      ...
                      <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                        ...
                        গোপনীয়তার নীতি আপডেট করার (পরিবর্তন, সংশোধন, যোগ
                        এবং/অথবা মুছে ফেলার) অধিকার সংরক্ষণ করি। গোপনীয়তা নীতির
                        যে কোন ধরনের পরিবর্তন নোটিফিকেশনের মাধ্যমে জানিয়ে দেওয়া
                        হবে।
                      </p>
                    </div>
                  </div>
                ...
                <div className="mt-[15px]">
                  <div>
                    <p className="text-[#101011] text-opacity-90 font-normal font-noto text-[14px]">
                      ...
                      hello@getfit.com.bd এ আমাদের সাথে নির্দ্বিধায় যোগাযোগ
                      করুন। গেটফিটের সাথে থাকার জন্য আপনাকে অনেক ধন্যবাদ।
                    </p>
                  </div>
                </div>
              </div>
